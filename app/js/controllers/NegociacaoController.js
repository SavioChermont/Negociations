        ...
        execute: function () {
            NegociacaoController = class NegociacaoController {
                ...
                adiciona(event) {
                    ...
                    const negociacao = new Negociacao_1.Negociacao(new Date(this._inputData.val().toString().replace("/-/g", ",")), parseInt(this._inputQuantidade.val().toString()), parseFloat(this._inputValor.val().toString()));
